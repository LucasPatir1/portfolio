    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg">
        ...
        <p className="mb-4 py-6">
          Hey! I am Lucas, Senior Front-end developer with 5+ years of
          experience in Front-end development. Proficient in React, HTML, CSS,
          SCSS, Tailwindcss, MUI, Styled components, Bootstrap, GSAP, Figma,
          etc. Clients are always satisfied with my speed and code quality.
        </p>
